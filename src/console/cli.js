...
const { loadFileWithSource } = require('../lib/yaml-with-source');
...
const options = [{
  ...
  flag: 'u',
  default: false,
  description: 'Enable tracing harness and admin UI (starts admin portal).'
}, {
  name: 'pfx',
  flag: 'p',
  param: 'file',
...
function data (filename) {
  ...
  try {
    return loadFileWithSource(filename);
  } catch (e) {
