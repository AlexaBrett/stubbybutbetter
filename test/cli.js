...
describe('CLI', function () {
  ...
  describe('getArgs', function () {
    describe('-u, --ui', function () {
      it('should return default (false) if no flag provided', function () {
        const expected = false;
        const actual = sut.getArgs([]);
        assert.strictEqual(!!actual.ui, expected);
      });

      it('should return true when -u is provided', function () {
        const actual = sut.getArgs(['-u']);
        assert.strictEqual(actual.ui, true);
      });

      it('should return true when --ui is provided', function () {
        const actual = sut.getArgs(['--ui']);
        assert.strictEqual(actual.ui, true);
      });
    });
